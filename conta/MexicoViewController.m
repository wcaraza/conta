...
//  conta
//
//  Created by Walter Caraza Barrera on 30/10/12.
...
- (void)viewDidLoad {
    ...
    UIImage *logo = [UIImage imageNamed:@"1348957361_Mexico-Flag.png"];
...
-(NSMutableArray *) listar{
    ...
    @try {
        ...
        const char *elemento = "SELECT ide,desc FROM elemento WHERE pais=2 ORDER BY orden";
        sqlite3_stmt *xor;
        ...
        while(sqlite3_step(xor)==SQLITE_ROW){
            ...
            if(sqlite3_prepare(db, sql, -1, &sqlStatement, NULL) != SQLITE_OK)
            {
                ...
                while (sqlite3_step(sqlStatement)==SQLITE_ROW) {
                    ...
                    MexicoViewController *x = [[MexicoViewController alloc]init];
                    x.ide = [ide intValue];
                    x.name =  name;
                    x.title = title;
                    x.explicacion = exp;
...
- (NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section {
	...
	switch (section) {
        ...
        case 2:return @"3. HACIENDA PÚBLICA/PATRIMONIO";break;
        case 3:return @"4. INGRESOS";break;
        case 4:return @"5. GASTOS Y OTRAS PÉRDIDAS";break;
        case 5:return @"6. CUENTAS DE CIERRE O CORTE CONTABLE";break;
        case 6:return @"7. CUENTAS DE ORDEN CONTABLES";break;
        case 7:return @"8. CUENTAS DE ORDEN PRESUPUESTARIAS";break;
        case 8:return @"9. CUENTAS DE LIQUIDACIÓN Y CIERRE PRESUPUESTARIO";break;
    }
    return nil;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if(searching){
        ...
        x = [dictionary objectForKey:@"cuentas"];
        detail.selectIndex = x.ide;detail.cellName = x.name;detail.explicacion = x.explicacion;detail.pais = @"mexico";
