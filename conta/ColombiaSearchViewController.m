//
//  ColombiaSearchViewController.m
//  conta
//
...
#import "ColombiaSearchViewController.h"
#import "AppDelegate.h"
#import "DetailViewController.h"
#import "OverlayViewController.h"
#import <sqlite3.h>

@implementation ColombiaSearchViewController
...
- (void) doneMenu_Clicked:(id)sender {
	...
	[mainDelegate flipToBackBuscarColombia];
}
        ...
        while(sqlite3_step(xor)==SQLITE_ROW){
            ...
            if(sqlite3_prepare(db, sql, -1, &sqlStatement, NULL) != SQLITE_OK)
            {
                ...
                while (sqlite3_step(sqlStatement)==SQLITE_ROW) {
                    ...
                    ColombiaSearchViewController *x = [[ColombiaSearchViewController alloc]init];
                    x.ide = [ide intValue];
                    x.name =  name;
                    x.title = title;
                    x.explicacion = exp;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ColombiaSearchViewController *x;
